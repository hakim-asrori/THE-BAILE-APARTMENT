<template>
    <CCard>
        ...
        <CCardHeader
            class="d-md-flex align-items-center justify-content-between gap-3"
        >
            <div>
                <CButton
                    size="sm"
    ...
    <CModal
        ...
        "
        aria-labelledby="showMessageModal"
    >
        <CModalHeader>
            <CModalTitle id="showMessageModal"> Upload Image </CModalTitle>
        </CModalHeader>
...
export default {
    ...
    methods: {
        getGalleries() {
            this.isLoading = true;
            this.$store
                .dispatch("postData", ["gallery/view", this.formPagination])
                .then((response) => {
        ...
        deleteGallery(id) {
            this.$swal({
                ...
                if (result.isConfirmed) {
                    this.$store
                        .dispatch("postData", ["gallery/delete/" + id, {}])
                        .then((response) => {
                            this.getGalleries();
                            this.$swal({
                                title: "Deleted!",
        ...
        handleSubmit() {
            ...
            this.$store
                .dispatch("postData", ["gallery/store", formData])
                .then((response) => {
