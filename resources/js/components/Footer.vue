<template>
    <div>
      ...
      <div class="w-full md:w-1/3 h-44 p-2">
        <p>
      ...
      <div class="w-full md:w-1/3 h-44 flex flex-col">
        <div class="flex flex-grow h-full items-center">
          <p class="font-sans text-primaryColor w-full justify-center flex">
            HOME
          </p>
          <p class="font-sans text-primaryColor w-full justify-center flex">
            FACILITIES
    ...
    <div class="w-full h-16 flex flex-col md:flex-row justify-between items-center">
